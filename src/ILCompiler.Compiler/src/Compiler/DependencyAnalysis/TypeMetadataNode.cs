...
namespace ILCompiler.DependencyAnalysis
{
    ...
    internal class TypeMetadataNode : DependencyNodeCore<NodeFactory>
    {
        ...
        public override IEnumerable<DependencyListEntry> GetStaticDependencies(NodeFactory factory)
        {
            ...
            CustomAttributeBasedDependencyAlgorithm.AddDependenciesDueToCustomAttributes(ref dependencies, ilScanNodeFactory, ((Internal.TypeSystem.Ecma.EcmaType)_type));

            DefType containingType = _type.ContainingType;
            if (containingType != null)
                dependencies.Add(ilScanNodeFactory.TypeMetadata((MetadataType)containingType), "Containing type of a reflectable type");
            else
                dependencies.Add(ilScanNodeFactory.ModuleMetadata(_type.Module), "Containing module of a reflectable type");
        ...
        /// express the dependency in metadata.
        /// </summary>
        public static void GetMetadataDependencies(ref DependencyList dependencies, ILScanNodeFactory nodeFactory, TypeDesc type, string reason)
        {
            ...
            switch (type.Category)
            {
                ...
                default:
                    ...
                    {
                        if (mdManager.GeneratesMetadata(typeDefinition))
                        {
                    ...
                    {
                        if (mdManager.GeneratesMetadata(type))
                        {
